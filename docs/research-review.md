...
用户图里的 README 架构是合理的：先建立信任和定位，再给快速开始，再用 GIF 或截图解释核心路径，随后说明差异、AI 调用方式、文档和贡献方式。这个顺序比传统“安装、使用、API”更适合第一次访问，也更适合让 agent 在最短路径里接手项目。
